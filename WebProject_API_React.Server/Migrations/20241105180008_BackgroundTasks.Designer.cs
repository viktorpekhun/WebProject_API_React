...
namespace WebProject_API_React.Server.Migrations
{
    ...
    [Migration("20241105180008_BackgroundTasks")]
            ...
            modelBuilder.Entity("WebProject_API_React.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "password1",
                            RefreshToken = "token",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 5, 20, 0, 7, 936, DateTimeKind.Utc).AddTicks(2431),
                            Username = "Bob"
                        },
                        new
                        {
                            ...
                            Password = "password2",
                            RefreshToken = "token",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 5, 20, 0, 7, 936, DateTimeKind.Utc).AddTicks(2435),
                            Username = "Rick"
                        },
                        new
                        {
                            ...
                            Password = "password3",
                            RefreshToken = "token",
                            RefreshTokenExpiryTime = new DateTime(2024, 11, 5, 20, 0, 7, 936, DateTimeKind.Utc).AddTicks(2438),
                            Username = "John"
                        });
                });
